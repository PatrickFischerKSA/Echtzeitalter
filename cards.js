// -------------------------------------------------------
// Marianumopoly – Karten (Daten)
// Diese Datei enthält ausschließlich die Kartendefinitionen
// und kann von index.html UND cards.html genutzt werden.
// -------------------------------------------------------
...
const dolinarCards = [
  ...
  },
  {
    ...
    text: "Du schreibst gegen Erwartungen an – leise, aber klar.",
    effect: "Erhalte 80 € und rücke zum nächsten Bibliotheks- oder Informatikfeld."
  }
];


// -------------------------------------------------------
// Export-Objekt für andere JS-Dateien
// (funktioniert in Browsern ohne Module automatisch)
// -------------------------------------------------------

window.MarianumCards = {
  eventCards: eventCards,
  dolinarCards: dolinarCards
};
